...
class BaseClass:
    ...
    def verifyVisibility(self, webElement=None):
        element = WebDriverWait(self.driver, 10).until(EC.visibility_of(webElement))

    def verifyClickability(self, webElement=None):
        element = WebDriverWait(self.driver, 10).until(EC.element_to_be_clickable(webElement))
